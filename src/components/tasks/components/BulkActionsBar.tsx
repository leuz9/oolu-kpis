...
export default function BulkActionsBar({
  ...
  return (
    <>
      <div className="fixed bottom-4 sm:bottom-6 left-1/2 transform -translate-x-1/2 z-50 animate-slide-down w-full max-w-[95vw] sm:max-w-[90vw] px-2 sm:px-0">
        <div className="bg-white rounded-xl shadow-2xl border-2 border-primary-200 px-3 sm:px-4 py-2 sm:py-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 w-full max-w-full">
          <div className="flex items-center gap-2 sm:gap-3 flex-1 flex-wrap">
            <div className="px-2 sm:px-3 py-1 sm:py-1.5 bg-primary-100 rounded-lg">
              <span className="font-semibold text-sm sm:text-base text-primary-700">{selectedTasks.length}</span>
              <span className="text-primary-600 ml-1 text-xs sm:text-sm">
            ...
            <div className="relative">
              <button
                ...
                disabled={processing}
                className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors disabled:opacity-50"
              >
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-medium">Priority</span>
              </button>
              {showPriorityMenu && (
                <div className="absolute bottom-full left-0 mb-2 bg-white rounded-lg shadow-xl border border-gray-200 py-2 min-w-[180px] z-50">
            ...
            <button
              ...
              disabled={processing}
              className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-lg transition-colors disabled:opacity-50"
            >
          ...
          <button
            ...
            disabled={processing}
            className="p-1.5 sm:p-2 hover:bg-gray-100 rounded-lg transition-colors disabled:opacity-50 flex-shrink-0 self-start sm:self-auto"
          >
